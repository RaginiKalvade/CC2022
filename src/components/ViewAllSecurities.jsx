...
class ViewAllSecurities extends Component {
    ...
    findAll() {
        return axios.get("http://localhost:8080/api/v1/security");
    }
    getSearch=(event)=>{
            ...
            <div>
                ...
                <div className="col-lg-3 col-md-3 col-sm-12 p-0">
                    <select name="filter" className="form-select" value={this.state.filter} onChange={this.getFilter}>
                        ...
                        <option value="findNation">Maturity date</option>
                        <option value="findClub">Status</option>
                        <option value="findPosition">Issuer</option>
                    </select>
                </div>
